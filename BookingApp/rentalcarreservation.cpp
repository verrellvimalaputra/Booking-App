...
RentalCarReservation::RentalCarReservation(std::string id, long travelId, double price, std::string fromDate, std::string toDate, std::string predecessor1, std::string predecessor2,
    ...
    Booking(id, travelId, price, fromDate, toDate, predecessor1, predecessor2), pickupLocation(pickupLocation),
