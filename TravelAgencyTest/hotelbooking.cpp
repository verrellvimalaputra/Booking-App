...
HotelBooking::HotelBooking(std::string id, double price, std::string fromDate, std::string toDate,
                           std::string hotel, std::string town, std::string roomType, double hotelLatitude, double hotelLongitude) :
    Booking(id, price, fromDate, toDate), hotel(hotel), town(town), roomType(roomType), hotelLatitude(hotelLatitude), hotelLongitude(hotelLongitude)
{
}
